...
% load('BackUp_Simulation_Dataset_007GS.mat')
load('BackUp_Simulation_Dataset_009.mat')
%%
% load('TableData_006.mat')
load('TableData_009.mat')
%%              
        ...
        %     end
        % end
        % save('TableData_009.mat', "TABLEDATA")
...
%%
% % % aux = 1: means que quieres ver el subplot con las 4-
% % % aux = 2: means que quieres exportar las figuras
aux = 1;
name = 'gs';
basename = ['cap55_rampas_', name, '_' ];
if aux == 1
    figure()
    subplot(2,2,1)
    Showlog(logsout, 'v', 0)
